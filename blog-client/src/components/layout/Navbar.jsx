            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <button onClick={handleLogout} className="hover:text-red-600 transition flex items-center space-x-1">
                            <FiLogOut size={20} />
                    ...
                    <div className="md:hidden flex flex-col space-y-1 cursor-pointer" onClick={() => setShowMenu(!showMenu)}>
